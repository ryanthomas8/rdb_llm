...
class DevelopmentConfig:
    ...
    SQLALCHEMY_DATABASE_URI = (
        ...
        or "postgresql+psycopg2://postgres:mysecretpassword@postgres:5432/postgres"
    )
...
class DevelopmentLocalConfig:
    ...
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = (
        os.environ.get("DATABASE_URL_DEV_LOCAL")
        or "postgresql+psycopg2://postgres:mysecretpassword@localhost:5432/postgres"
    )
